 ...
 * This class provides helper methods to the USenseDataSource.
 ...
 *
 */
public class UsenseSQLiteHelper extends SQLiteOpenHelper{

	public static final String DATABASE_NAME = "usense.db";
	...
	/**
	 * This method construct the UsenseSQLiteHelper with the help of Android Context
	 * @param context Interface to global information about an application environment.
	 */
	public UsenseSQLiteHelper(Context context) {

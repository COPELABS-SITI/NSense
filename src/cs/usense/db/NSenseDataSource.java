...
public class NSenseDataSource {
	 ...
	 */
	public NSenseDataSource (Context context) {
	...
	public long getNumAP(){
		return DatabaseUtils.queryNumEntries(db, NSenseSQLiteHelper.TABLE_ACCESSPOINTS);
	}
	...
	private String[] allColumnsActionsEntry = { 
			NSenseSQLiteHelper.COLUMN_ACTIONTYPE,
			NSenseSQLiteHelper.COLUMN_TIMESTAMP,
			NSenseSQLiteHelper.COLUMN_ENDTIMESTAMP,
			NSenseSQLiteHelper.COLUMN_AVGDURATION,
			NSenseSQLiteHelper.COLUMN_HOUR,
			NSenseSQLiteHelper.COLUMN_ACTIONCOUNTER,
			NSenseSQLiteHelper.COLUMN_DAY,
			NSenseSQLiteHelper.COLUMN_TIMEFRAME
	};
	...
	public long getNumActionEntry(){
		return DatabaseUtils.queryNumEntries(db, NSenseSQLiteHelper.TABLE_ACTIONS);
	}
	...
	public long registerNewActionEntry (ActionsEntry ae) {
		...
		values.put(NSenseSQLiteHelper.COLUMN_ACTIONTYPE, ae.getActionType());
		values.put(NSenseSQLiteHelper.COLUMN_TIMESTAMP, ae.getActionStartTime());
		values.put(NSenseSQLiteHelper.COLUMN_ENDTIMESTAMP, ae.getActionEndTime());
		values.put(NSenseSQLiteHelper.COLUMN_AVGDURATION, ae.getAverageDuration());
		values.put(NSenseSQLiteHelper.COLUMN_HOUR, ae.getHour());
		values.put(NSenseSQLiteHelper.COLUMN_ACTIONCOUNTER, ae.getActionCounter());
		values.put(NSenseSQLiteHelper.COLUMN_DAY, ae.getDay());
		values.put(NSenseSQLiteHelper.COLUMN_TIMEFRAME, ae.getTimeFrame());
	...
	public boolean updateActionEntry(ActionsEntry ae) {
		String identifier = NSenseSQLiteHelper.COLUMN_TIMESTAMP + "='" + ae.getActionStartTime() + "'";
		ContentValues values = new ContentValues();
		values.put(NSenseSQLiteHelper.COLUMN_ACTIONTYPE, ae.getActionType());
		values.put(NSenseSQLiteHelper.COLUMN_TIMESTAMP, ae.getActionStartTime());
		values.put(NSenseSQLiteHelper.COLUMN_ENDTIMESTAMP, ae.getActionEndTime());
	...
	public ActionsEntry getActionEntry( String actionentry) {
		ActionsEntry ae;
		Cursor cursor = db.query(NSenseSQLiteHelper.TABLE_ACTIONS, allColumnsActionsEntry, NSenseSQLiteHelper.COLUMN_ACTIONTYPE + "='" + actionentry + "'", null, null, null, null);
	...
	public boolean hasActionEntry (String actionType) {
		return (DatabaseUtils.longForQuery(db, "SELECT COUNT(*) FROM " + NSenseSQLiteHelper.TABLE_ACTIONS + " WHERE " + NSenseSQLiteHelper.COLUMN_ACTIONTYPE + "='" + actionType + "'", null) == 0)? false : true;
	}
	...
	public Map<String, ActionsEntry> getAllActionEntry() {
		...
		Cursor cursor = db.query(NSenseSQLiteHelper.TABLE_ACTIONS, allColumnsActionsEntry, null, null, null, null, null);
		cursor.moveToFirst();
	...
	public long getNumBTDevice(){
		return DatabaseUtils.queryNumEntries(db, NSenseSQLiteHelper.TABLE_BTDEVICE);
	}
	...
	public void registerNewBTDevice (BTUserDevice btDev, BTUserDevEncounterDuration duration, 
		...
		//		    return db.insert(NSenseSQLiteHelper.TABLE_BTDEVICE, null, values);
	}
	...
	public boolean hasBTDevice (String btDev) {
		return (DatabaseUtils.longForQuery(db, "SELECT COUNT(*) FROM " + NSenseSQLiteHelper.TABLE_BTDEVICE + " WHERE " + NSenseSQLiteHelper.COLUMN_BTDEV_MAC_ADDRESS + "='" + btDev + "'", null) == 0)? false : true;
	}
	...
	public long getNumEntries(){
		return DatabaseUtils.queryNumEntries(db, NSenseSQLiteHelper.TABLE_LOCATION);
	}
	...
	public LocationEntry getLocationEntry(String bssid) {
		LocationEntry ap;
		Cursor cursor = db.query(NSenseSQLiteHelper.TABLE_LOCATION, allColumnsLocation, NSenseSQLiteHelper.COLUMN_BSSID + "='" + bssid + "'", null, null, null, null);
		if (cursor.moveToFirst())
	...
	public boolean hasLocationEntry (String bssid) {
		return (DatabaseUtils.longForQuery(db, "SELECT COUNT(*) FROM " + NSenseSQLiteHelper.TABLE_LOCATION + " WHERE " + NSenseSQLiteHelper.COLUMN_MAC_ADDRESS + "='" + bssid + "'", null) == 0)? false : true;
	}
	...
	public long getNumSoundLevel(){
		return DatabaseUtils.queryNumEntries(db, NSenseSQLiteHelper.TABLE_SOUND);
	}
	...
	public long registerNewSoundLevel (SoundLevel sl) {
		...
		cv.put(NSenseSQLiteHelper.NOISE_MILLIS, sl.getNoiseTime());
	...
	public boolean updateSoundLevel(SoundLevel sl) {
		...
		ContentValues values = new ContentValues();
		values.put(NSenseSQLiteHelper.KEY_ROWID, sl.getRowID());
		...
		values.put(NSenseSQLiteHelper.NOISE_MILLIS, sl.getNoiseTime());
	...
	public SoundLevel getSoundLevel(long todayMillis) {
		SoundLevel sl;
		Cursor cursor = db.query(NSenseSQLiteHelper.TABLE_SOUND, allColumnsSound, NSenseSQLiteHelper.SOUND_DATE + "='" + todayMillis + "'", null, null, null, null, null);
		if (cursor.moveToFirst())
	...
	public boolean hasSoundLevel (long soundDate) {
		return (DatabaseUtils.longForQuery(db, "SELECT COUNT(*) FROM " + NSenseSQLiteHelper.TABLE_SOUND + " WHERE " + NSenseSQLiteHelper.SOUND_DATE + "='" + soundDate + "'", null) == 0)? false : true;
	}
	...
	public Map<String, SoundLevel> getAllSoundLevel() {
		...
		Cursor cursor = db.query(NSenseSQLiteHelper.TABLE_SOUND, allColumnsSound, null, null, null, null, null);
		cursor.moveToFirst();

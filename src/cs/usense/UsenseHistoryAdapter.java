 ...
 * Class is part of the USense application. It provides support to the USense History Activity, and 
...
/**
 * This class provides adapter details to the UsenseHistoryActivity 
 */
public class UsenseHistoryAdapter extends ArrayAdapter<SocialityDetails>{

	private static final String TAG = "UsenseHistoryAdapter";
	...
	/**
	 * This method construct the UsenseHistoryAdapter with the context provided by USense Activity class
	 ...
	 */
	public UsenseHistoryAdapter(Context context, List<SocialityDetails> data, int layoutResourceId,  UsenseActivity listActivity) {

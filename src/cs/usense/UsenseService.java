 ...
 * Class is part of the USense application. It initialize and controls all the pipelines/modules, database and send the information to the USenseActivity.
 ...
 */
public class UsenseService extends Service {
	...
	/**
	 * This class binds the USense service
	 *
	 */
	public class LocalBinder extends Binder {
		UsenseService getService() {
			return UsenseService.this;
		}
	}
	...
	{
		//database
		dataSource = new UsenseDataSource(this);
	...
	public void runAsForeground(){
		Intent notificationIntent = new Intent(this, UsenseActivity.class);
	...
	/**
	 * This method close the USense service if it is running on foreground
	 */
	...
	/**
	 * This method close all the pipelines from the USense Service
	 */
	public void onDestroy()
	{
		mLocationPipeline.close();
		bluetooth.close(UsenseService.this);
		mIcrophone.close(UsenseService.this);
		dataSource.closeDB();
		mAccelerometerPipeline.close(UsenseService.this);
		mSocialInteraction.close(UsenseService.this);
		stopForeground(true);
		timer.cancel();
		timer.purge();

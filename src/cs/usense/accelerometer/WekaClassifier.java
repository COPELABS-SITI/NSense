 ...
 * Class is part of the USense application. This class is provided as input the classify the the activities in real time.
...
public class WekaClassifier {
	 ...
	 * @param Object Object with activity instances
	 * @return activity The current activity
	 */
	public static double classify1(Object[] i)
			throws Exception {

		double p = Double.NaN;
		p = WekaClassifier.N7dfcb280(i);
		return p;
	}
